...
def main():
    ...
    period = spx[(spx['Date'] >= '2008-07-01') & (spx['Date'] <= '2009-03-31')].copy()
    ...
    plt.tight_layout()
    plt.savefig('../../results/plots/2008_forecast.png', bbox_inches='tight', dpi=300)
    print("saved to results/plots/2008_forecast.png")
